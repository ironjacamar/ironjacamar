...
The full test suite every time you build the project
...
The checkstyle report is generated on every build and can ve find under each module's build directory

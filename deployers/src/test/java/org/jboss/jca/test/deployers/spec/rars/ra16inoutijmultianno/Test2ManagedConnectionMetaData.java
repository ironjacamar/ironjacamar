 ...
 * @version $Revision: $
 */
public class Test2ManagedConnectionMetaData implements ManagedConnectionMetaData
{
   /** The logger */
   private static Logger log = Logger.getLogger("Test2ManagedConnectionMetaData");

   /**
    * Default constructor
    */
   public Test2ManagedConnectionMetaData()
   {

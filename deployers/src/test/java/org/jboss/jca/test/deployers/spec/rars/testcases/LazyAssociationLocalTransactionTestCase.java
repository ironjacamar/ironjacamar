...
public class LazyAssociationLocalTransactionTestCase
{
   ...
   public static Descriptor createDescriptor() throws Exception
   {
      ...
      InputStreamDescriptor isd = new InputStreamDescriptor("lazy-localtx-ra.xml", 
                                                            cl.getResourceAsStream("lazy-localtx-ra.xml"));
      return isd;
   }

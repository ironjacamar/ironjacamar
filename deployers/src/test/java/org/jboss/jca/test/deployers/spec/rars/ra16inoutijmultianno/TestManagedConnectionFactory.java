 ...
 * @version $Revision: $
 */
@ConnectionDefinition(connectionFactory = TestConnectionFactory.class,
...
public class TestManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation
{
   ...
   public int hashCode()
   {
      ...
      if (byteProperty != null)
         result += 31 * result + 7 * byteProperty.hashCode();
      else
         result += 31 * result + 7;
      return result;
   }
   ...
   public boolean equals(Object other)
   {
      ...
      {
         if (byteProperty == null)
            result = obj.getByteProperty() == null;
         else
            result = byteProperty.equals(obj.getByteProperty());
      }
      return result;
   }

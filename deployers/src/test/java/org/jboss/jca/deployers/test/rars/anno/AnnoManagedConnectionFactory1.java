...
public class AnnoManagedConnectionFactory1 implements ManagedConnectionFactory, ResourceAdapterAssociation
{
   ...
   /** first */
   @ConfigProperty(defaultValue = "2", description =  {"1st", "first" }, 
    ...
    */
   @ConfigProperty(defaultValue = "1", description =  {"2nd", "second" }, 
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof AnnoManagedConnectionFactory1))
         return false;
      boolean result = true;

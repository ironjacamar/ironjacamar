...
public class LazyAssociationLocalTransactionMTTestCase extends LazyTestBase
{
   /** The logger */
   private static Logger log = Logger.getLogger(LazyAssociationLocalTransactionMTTestCase.class);

...
@Connector(
   ...
   authMechanisms = 
      ...
      @AuthenticationMechanism(credentialInterface = CredentialInterface.GenericCredential, 
...
public class AnnoResourceAdapter1 implements ResourceAdapter, java.io.Serializable
{
   ...
   /** first */
   @ConfigProperty(defaultValue = "A", description = {"1st", "first" }, 
    ...
    */
   @ConfigProperty(defaultValue = "5", description =  {"2nd", "second" },
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof AnnoResourceAdapter1))
         return false;
      boolean result = true;
      AnnoResourceAdapter1 obj = (AnnoResourceAdapter1)other;
      if (result)
      {
         if (first == null)

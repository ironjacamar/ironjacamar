      ...
      ResourceAdapterAssociation
{
   ...
   /** The logger */
   private static Logger log = Logger.getLogger("SimpleManagedConnectionFactoryWODefConstructor");
   ...
   /**
    * 
    * Create a new SimpleManagedConnectionFactoryWODefConstructor.
    * 
    * @param f first property
    * @param c second property
    */
   public SimpleManagedConnectionFactoryWODefConstructor(String f, Character c)
   {
      first = f;
      second = c;
   }

 ...
 * @version $Revision: $
 */
public class SimpleManagedConnectionFactoryWOEquals implements ManagedConnectionFactory, ResourceAdapterAssociation
{
   ...
   /** The logger */
   private static Logger log = Logger.getLogger("SimpleManagedConnectionFactoryWOEquals");
    ...
    * Default constructor
    */
   public SimpleManagedConnectionFactoryWOEquals()
   {

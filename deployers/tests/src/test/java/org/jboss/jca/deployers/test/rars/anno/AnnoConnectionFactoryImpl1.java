...
public class AnnoConnectionFactoryImpl1 implements AnnoConnectionFactory1
{
    ...
    */
   public AnnoConnectionFactoryImpl1(AnnoManagedConnectionFactory1 mcf, ConnectionManager cxManager)
   {
      this.mcf = mcf;
   ...
   public AnnoConnection1 getConnection() throws ResourceException
   {
      ...
      return (AnnoConnection1)connectionManager.allocateConnection(mcf, null);
   }

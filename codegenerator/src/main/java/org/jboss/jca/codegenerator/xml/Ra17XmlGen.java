...
public class Ra17XmlGen extends RaXmlGen
{
   ...
   void writeConnectorVersion(Writer out) throws IOException
   {
      ...
      writeEol(out);
      writeEol(out);
      out.write("<connector xmlns=\"http://xmlns.jcp.org/xml/ns/javaee\"");
      writeEol(out);
      out.write("           xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"");
      writeEol(out);
      out.write("           xsi:schemaLocation=\"http://xmlns.jcp.org/xml/ns/javaee");
      writeEol(out);
      out.write("           http://xmlns.jcp.org/xml/ns/javaee/connector_1_7.xsd\"");
      writeEol(out);
      out.write("           version=\"1.7\" metadata-complete=\"true\">");
      writeEol(out);
      writeEol(out);
   }

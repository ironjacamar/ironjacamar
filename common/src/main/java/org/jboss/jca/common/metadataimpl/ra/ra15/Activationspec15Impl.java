 ...
 */
package org.jboss.jca.common.metadataimpl.ra.ra15;
...
public class Activationspec15Impl implements Activationspec15
{
    ...
    */
   public Activationspec15Impl(XsdString activationspecClass, ArrayList<RequiredConfigProperty> requiredConfigProperty,
         String id)
   {
      super();

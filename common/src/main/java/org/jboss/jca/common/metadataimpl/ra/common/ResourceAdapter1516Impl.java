...
public class ResourceAdapter1516Impl implements ResourceAdapter1516
{
   ...
   private final ArrayList<? extends ConfigProperty> configProperties;
    ...
    * @param id XML ID
    */
   public ResourceAdapter1516Impl(String resourceadapterClass, ArrayList<? extends ConfigProperty> configProperties,
         OutboundResourceAdapter outboundResourceadapter, InboundResourceAdapter inboundResourceadapter,
         ArrayList<AdminObject> adminobjects, ArrayList<SecurityPermission> securityPermissions, String id)
   {
      super();
   ...
   public ResourceAdapter1516 merge(MergeableMetadata<?> jmd) throws Exception
   {
      if (jmd instanceof ResourceAdapter1516Impl)
      {
         ...
         ArrayList<SecurityPermission> newSecurityPermission = MergeUtil.mergeArrayList(this.securityPermissions,
               inputRA.securityPermissions);
         ArrayList<? extends ConfigProperty> newConfigProperties = MergeUtil.mergeConfigArrayList(
               this.configProperties,
               inputRA.configProperties);
         ArrayList<AdminObject> newAdminobjects = MergeUtil.mergeArrayList(this.adminobjects, inputRA.adminobjects);

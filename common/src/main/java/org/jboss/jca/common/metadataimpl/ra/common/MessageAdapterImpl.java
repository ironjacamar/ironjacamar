...
public class MessageAdapterImpl implements Messageadapter
{
    ...
    * @param id XML ID
    */
   public MessageAdapterImpl(ArrayList<MessageListener> messagelisteners, String id)
   {
      super();
   ...
   public Messageadapter merge(MergeableMetadata<?> jmd) throws Exception
   {
      if (jmd instanceof MessageAdapterImpl)
      {
         ...
         ArrayList<MessageListener> newMessagelistener = MergeUtil.mergeArrayList(this.messagelisteners,

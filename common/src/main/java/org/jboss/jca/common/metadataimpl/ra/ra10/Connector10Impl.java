 ...
 */
package org.jboss.jca.common.metadataimpl.ra.ra10;
...
import org.jboss.jca.common.metadataimpl.ra.common.ConnectorAbstractmpl;
...
public final class Connector10Impl extends ConnectorAbstractmpl implements Connector10
{
    ...
    * @param id XML ID
    */
   public Connector10Impl(String moduleName, ArrayList<LocalizedXsdString> description, XsdString displayName,

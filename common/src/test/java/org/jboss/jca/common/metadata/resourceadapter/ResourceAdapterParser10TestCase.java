...
/**
 *
 * A ResourceAdapterParser10TestCase.
 *
 * @author <a href="mailto:vrastsel@redhat.com">Vladimir Rastseluev</a>
 *
 */
public class ResourceAdapterParser10TestCase extends XMLParserTestBase
{
   /**
   *
   * beforeClass method
   ...
   */
   ...
   public static void beforeClass()
   {
      ...
      parsedFileName = "resource-adapter/unit/complex-10-ra.xml";
   }

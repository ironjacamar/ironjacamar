...
/**
 *
 * A ResourceAdapterParser11TestCase.
 *
 * @author <a href="mailto:vrastsel@redhat.com">Vladimir Rastseluev</a>
 *
 */
public class ResourceAdapterParser11TestCase extends XMLParserTestBase
{
   /**
   *
   * beforeClass method
   ...
   */
   ...
   public static void beforeClass()
   {
      ...
      parsedFileName = "resource-adapter/unit/complex-11-ra.xml";
   }

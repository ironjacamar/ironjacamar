...
public interface AdminObjectGroup extends WlsMetadata
{
    ...
    * 
    * @return the List<AdminObjectInstance>
    * 
    */
   ...
   */
   public enum Tag 
   {
      ...
      /**
       * admin-object-interface tag
       */
      ADMIN_OBJECT_INTERFACE("admin-object-interface"),

      /**
       * admin-object-class tag
       */
      ADMIN_OBJECT_CLASS("admin-object-class"),
      ...
      /**
       * admin-object-instance tag
       */
      ADMIN_OBJECT_INSTANCE("admin-object-instance");

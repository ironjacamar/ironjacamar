...
public class ConfigPropertiesImpl implements ConfigProperties
{
   ...
   private static final long serialVersionUID = -2654156739973647325L;
   
   private final ArrayList<ConfigProperty> props;
   
   /**
    * construct
    * 
    * @param props ArrayList<ConfigProperty>
    */
   ...
   /* (non-Javadoc)
    * @see org.jboss.jca.as.converters.wls.api.metadata.ConfigProperties#getProperty()
    */
   @Override

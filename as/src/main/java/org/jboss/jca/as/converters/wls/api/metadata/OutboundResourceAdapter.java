...
public interface OutboundResourceAdapter extends WlsMetadata
{
   ...
   /**
    * getConnectionDefinitionGroup
    * 
    * @return the List<ConnectionDefinition>
    */
   ...
   */
   public enum Tag
   {
      ...
      /**
       * connection-definition-group tag
       */
      CONNECTION_DEFINITION_GROUP("connection-definition-group");

...
public class InboundGroupPrincipalMappingImpl implements InboundGroupPrincipalMapping
{
    ...
    * constructor
    * 
    * @param eisGroup eisGroup
    * @param mappedGroup mappedGroup
    */
   public InboundGroupPrincipalMappingImpl(String eisGroup, String mappedGroup)
   {
      this.eisGroup = eisGroup;
      this.mappedGroup = mappedGroup;
   }
   
   /* (non-Javadoc)
    * @see org.jboss.jca.as.converters.wls.api.metadata.InboundGroupPrincipalMapping#getEisGroupPrincipal()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see org.jboss.jca.as.converters.wls.api.metadata.InboundGroupPrincipalMapping#getMappedGroupPrincipal()
    */
   @Override

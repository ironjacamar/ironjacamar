...
/**
 * 
 * Java class for anon-principal-callerType complex type.
 * 
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "anon-principal-callerType", propOrder =
      { "useAnonymousIdentity", "principalName", "useCallerIdentity" })
public class AnonPrincipalCallerType
{
   ...
   /**
    * Specifies that the principal name should be used. This should match a 
    * defined WebLogic Server user name.
    *
    * @return
    *     possible object is
    *     {@link String }

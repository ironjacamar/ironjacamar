 ...
 *
 */
public interface ConnectionDefinition extends WlsMetadata
{
   /**
    ...
    *           
    * @return the ConnectionDefinitionProperties
    */
    ...
    * 
    * @return the List<ConnectionInstance>
    */
   ...
   */
   public enum Tag 
   {
      ...
      /**
       * connection-factory-interface tag
       */
      CONNECTION_FACTORY_INTERFACE("connection-factory-interface"),

      /**
       * default-connection-properties tag
       */
      DEFAULT_CONNECTION_PROPERTIES("default-connection-properties"),

      /**
       * connection-instance tag
       */

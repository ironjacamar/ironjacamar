...
/**
 *
 * A generic AnonPrincipalCaller.
 *
 * @author <a href="jeff.zhang@jboss.org">Jeff Zhang</a>
 *
 */
public interface AnonPrincipalCaller extends WlsMetadata
{
   /**
    * getUseAnonymousIdentity
    *           
    * @return the UseAnonymousIdentity
    */
   ...
   */
   public enum Tag 
   {
      ...
      /**
       * eis-caller-principal tag
       */
      EIS_CALLER_PRINCIPAL("eis-caller-principal"),

      /**
       * mapped-caller-principal tag
       */
      MAPPED_CALLER_PRINCIPAL("mapped-caller-principal");

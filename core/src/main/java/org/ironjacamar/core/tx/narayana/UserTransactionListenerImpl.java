 ...
 */
public class UserTransactionListenerImpl implements org.ironjacamar.core.spi.transaction.usertx.UserTransactionListener,
                                                    org.jboss.tm.usertx.UserTransactionListener
{
   /** The user transaction listener */
   private org.ironjacamar.core.spi.transaction.usertx.UserTransactionListener utl;

   /**
    * Constructor
    * @param utl The user transaction listener
    */
   public UserTransactionListenerImpl(org.ironjacamar.core.spi.transaction.usertx.UserTransactionListener utl)
   {
      this.utl = utl;
   }

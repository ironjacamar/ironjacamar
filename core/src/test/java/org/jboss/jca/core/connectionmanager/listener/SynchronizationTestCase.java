 ...
 */
public class SynchronizationTestCase
{
   private static Logger log = Logger.getLogger(SynchronizationTestCase.class);
   ...
   public static void beforeClass() throws Throwable
   {
      ...
      // Deploy
      URL stdio = SynchronizationTestCase.class.getClassLoader().getResource("stdio.xml");
      URL naming = SynchronizationTestCase.class.getClassLoader().getResource("naming.xml");
      URL transaction = SynchronizationTestCase.class.getClassLoader().getResource("validating-transaction.xml");
      URL jca = SynchronizationTestCase.class.getClassLoader().getResource("jca.xml");

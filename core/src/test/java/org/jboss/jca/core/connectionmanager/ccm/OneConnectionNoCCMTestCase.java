...
/**
 * One connection test case for CCM (NoTransaction)
 *
 * @author <a href="jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
@RunWith(Arquillian.class)
@Configuration(autoActivate = false)
public class OneConnectionNoCCMTestCase
{
   private static Logger log = Logger.getLogger(OneConnectionNoCCMTestCase.class);

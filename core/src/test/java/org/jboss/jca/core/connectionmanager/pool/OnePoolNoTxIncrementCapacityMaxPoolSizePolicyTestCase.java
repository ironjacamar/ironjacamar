...
/**
 * 
 * A OnePoolNoTxIncrementCapacityMaxPoolSizePolicyTestCase
 * 
 ...
 * 
 */
public class OnePoolNoTxIncrementCapacityMaxPoolSizePolicyTestCase extends OnePoolNoTxTestCaseAbstract
{
   ...
   public static IronjacamarDescriptor getIJ()
   {
      ...
      ijCdt.removePool().getOrCreatePool().getOrCreateCapacity().getOrCreateIncrementer()
         .className("org.jboss.jca.core.connectionmanager.pool.capacity.MaxPoolSizeIncrementer");

...
/**
 * 
 * A OnePoolNoTxIncrementCapacityWatermarkPolicyNullValueTestCase
 * 
 ...
 * 
 */
public class OnePoolNoTxIncrementCapacityWatermarkPolicyNullValueTestCase extends OnePoolNoTxTestCaseAbstract
{
   ...
   public void checkPool() throws Exception
   {
      ...
      checkStatistics(ps, 19, 1, 20);
      SimpleConnection c1 = cf.getConnection();
      Thread.sleep(1000);
      checkStatistics(ps, 18, 2, 20);
      c.close();
      c1.close();

...
/**
 * 
 * A OnePoolNoTxIncrementCapacitySizePolicyTestCase
 * 
 ...
 * 
 */
public class OnePoolNoTxIncrementCapacitySizePolicyTestCase extends OnePoolNoTxTestCaseAbstract
{
   ...
   public static IronjacamarDescriptor getIJ()
   {
      ...
      ijCdt.removePool().getOrCreatePool().getOrCreateCapacity().getOrCreateIncrementer()
         .className("org.jboss.jca.core.connectionmanager.pool.capacity.SizeIncrementer").getOrCreateConfigProperty()
         .name("size").text("2");

...
/**
 * An enlist / delist XA test case
 *
 * @author <a href="jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
public class EnlistDelistXATestCase extends EnlistDelist
{
   private static Logger log = Logger.getLogger(EnlistDelistXATestCase.class);

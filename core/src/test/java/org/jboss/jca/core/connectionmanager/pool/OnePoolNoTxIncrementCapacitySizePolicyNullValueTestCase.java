...
/**
 * 
 * A OnePoolNoTxIncrementCapacitySizePolicyNullValueTestCase
 * 
 ...
 * 
 */
public class OnePoolNoTxIncrementCapacitySizePolicyNullValueTestCase extends OnePoolNoTxTestCaseAbstract
{
   ...
   public static IronjacamarDescriptor getIJ()
   {
      ...
      ijCdt.removePool().getOrCreatePool().getOrCreateCapacity().getOrCreateIncrementer()
         .className("org.jboss.jca.core.connectionmanager.pool.capacity.SizeIncrementer");

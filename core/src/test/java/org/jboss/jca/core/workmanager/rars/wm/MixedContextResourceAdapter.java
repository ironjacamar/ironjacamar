...
@Connector(
   ...
   requiredWorkContexts = {UnsupportedContext.class, TransactionContext.class })
public class MixedContextResourceAdapter implements ResourceAdapter, java.io.Serializable
{
    ...
    * Default constructor
    */
   public MixedContextResourceAdapter()
   {
   ...
   public boolean equals(Object other)
   {
      ...
      if (!(other instanceof ContextResourceAdapter))
         return false;
      MixedContextResourceAdapter obj = (MixedContextResourceAdapter)other;

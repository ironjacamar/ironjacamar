...
public class ContextResourceAdapter implements ResourceAdapter, java.io.Serializable
{
   ...
   /**
    * Run doWork() method of WorkManager with work instantion
    * @param work - instantion
   ...
   public boolean equals(Object other)
   {
      ...
      if (!(other instanceof ContextResourceAdapter))
         return false;
      ContextResourceAdapter obj = (ContextResourceAdapter)other;

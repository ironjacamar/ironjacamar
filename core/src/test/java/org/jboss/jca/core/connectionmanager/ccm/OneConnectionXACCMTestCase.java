...
/**
 * One connection test case for CCM (XATransaction)
 *
 * @author <a href="jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
@RunWith(Arquillian.class)
@Configuration(autoActivate = false)
public class OneConnectionXACCMTestCase
{
   private static Logger log = Logger.getLogger(OneConnectionXACCMTestCase.class);
   ...
   public void testTwoTransactions() throws Throwable
   {
      ...
      assertEquals("3B83B8", c.getState());
      assertTrue(c.isInPool());

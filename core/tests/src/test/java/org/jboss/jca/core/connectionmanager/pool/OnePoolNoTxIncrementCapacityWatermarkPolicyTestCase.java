...
/**
 * 
 * A OnePoolNoTxIncrementCapacityWatermarkPolicyTestCase
 * 
 ...
 * 
 */
public class OnePoolNoTxIncrementCapacityWatermarkPolicyTestCase extends OnePoolNoTxTestCaseAbstract
{
   ...
   public static IronjacamarDescriptor getIJ()
   {
      ...
      ijCdt.removePool().getOrCreatePool().getOrCreateCapacity().getOrCreateIncrementer()
         .className("org.jboss.jca.core.connectionmanager.pool.capacity.WatermarkIncrementer")
         .getOrCreateConfigProperty().name("watermark").text("2");

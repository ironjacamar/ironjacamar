...
/**
 * A PoolByCriNoTxDecrementCapacityMinPoolSize
 * <p>
 ...
 */
public class PoolByCriNoTxDecrementCapacityMinPoolSizePolicyTestCase extends PoolByCriNoTxTestCaseAbstract
{
   ...
   {
      return createNoTxDeployment(getCriIJWithDecrementer("MinPoolSizeDecrementer"));
   }
   ...
   public void checkPool() throws Exception
   {
      ...
      // min-pool-size=2, but PoolByCri, so min-pool-size is hardcoded to 0

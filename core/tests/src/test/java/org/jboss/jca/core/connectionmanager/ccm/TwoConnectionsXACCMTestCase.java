...
/**
 * Two connections test case for CCM (XATransaction)
 *
 * @author <a href="jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
@RunWith(Arquillian.class)
@Configuration(autoActivate = false)
public class TwoConnectionsXACCMTestCase
{
   private static Logger log = Logger.getLogger(TwoConnectionsXACCMTestCase.class);
   ...
   public void testTwoConnections() throws Throwable
   {
      ...
      assertEquals("3B78", c1.getState());
      assertEquals("3B78", c2.getState());

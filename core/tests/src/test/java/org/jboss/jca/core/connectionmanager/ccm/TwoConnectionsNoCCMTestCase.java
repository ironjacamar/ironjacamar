...
/**
 * Two connections test case for CCM (NoTransaction)
 *
 * @author <a href="jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
@RunWith(Arquillian.class)
@Configuration(autoActivate = false)
public class TwoConnectionsNoCCMTestCase
{
   private static Logger log = Logger.getLogger(TwoConnectionsNoCCMTestCase.class);

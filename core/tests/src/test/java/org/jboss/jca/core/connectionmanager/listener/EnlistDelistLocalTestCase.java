...
/**
 * An enlist / delist local test case
 *
 * @author <a href="jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
public class EnlistDelistLocalTestCase extends EnlistDelist
{
   private static Logger log = Logger.getLogger(EnlistDelistLocalTestCase.class);

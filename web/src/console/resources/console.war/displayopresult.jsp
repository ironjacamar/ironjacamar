...
<head>
   ...
   <link rel="stylesheet" href="ironjacamar.css" type="text/css" />
   <link rel="shortcut icon" href="logo.ico" />
   <meta http-equiv="cache-control" content="no-cache" />
</head>

<jsp:useBean id='opResultInfo' class='org.ironjacamar.web.console.OpResultInfo' type='org.ironjacamar.web.console.OpResultInfo' scope='request'/>
<%
...
%>
  ...
  <table width="100%" class="copyright">
    <tr>
      <td class="copyright">
        Copyright &#169; 2016  <a href="http://www.ironjacamar.org/" target="_blank">IronJacamar</a>
      </td>
    </tr>
  </table>

...
/**
 * UnifiedSecurityRaMetaData
 *
 * @version $Revision: $
 */
public class UnifiedSecurityRaMetaData implements ResourceAdapterMetaData
{
   /**
    * Default constructor
    */
   public UnifiedSecurityRaMetaData()
   {
   ...
   {
      return "UnifiedSecurity resource adapter";
   }

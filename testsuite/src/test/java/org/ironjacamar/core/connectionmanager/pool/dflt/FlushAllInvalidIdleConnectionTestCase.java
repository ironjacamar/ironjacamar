...
public class FlushAllInvalidIdleConnectionTestCase
{
   /**
   ...
   private ResourceAdaptersDescriptor createNoTxNoPrefillActivation() throws Throwable
   {
      return ResourceAdapterFactory.createUnifiedSecurityDeployment(null, null,
            TransactionSupport.TransactionSupportLevel.NoTransaction,
            "UnifiedSecurityNoTxNoPrefillConnectionFactory", false, 0, "AllInvalidIdleConnections", true);
   }
   ...
   public void testWithinManagedConnectionPool() throws Throwable
   {
      ...
      c1.close();
      ((UnifiedSecurityConnectionImpl) c1).invalidate();
   ...
   public void testAcrossManagedConnectionPool() throws Throwable
   {
      ...
      UnifiedSecurityConnection thirdConnection = noTxNoPrefillCf.getConnection("user2", "pwd2");
      assertNotNull(thirdConnection);
      assertEquals("user2", thirdConnection.getUserName());
      assertEquals("pwd2", thirdConnection.getPassword());
      ...
      ManagedConnectionPool thirdMcp = iter.next();
      ...
      ConcurrentLinkedDeque<ConnectionListener> thirdListeners = (ConcurrentLinkedDeque<ConnectionListener>) TestUtils
            .extract(thirdMcp, "listeners");
      assertNotNull(thirdListeners);
      ...
      ((UnifiedSecurityConnectionImpl) secondConnection).invalidate();

 ...
 */
public class DistributedWorkManagerJGroupsMITestCase extends AbstractDistributedWorkManagerTest
{
   ...
   private static InputStreamDescriptor createBootstrapContext(int instanceNumber) throws Throwable
   {
      ...
      InputStreamDescriptor isd = new InputStreamDescriptor("dwm-jgroups.xml",
            cl.getResourceAsStream("dwm/instance-" + instanceNumber + "/dwm-jgroups.xml"));
      return isd;
   ...
   {
      return ResourceAdapterFactory.createWorkDeployment("DWMBC-JGroups");
   }

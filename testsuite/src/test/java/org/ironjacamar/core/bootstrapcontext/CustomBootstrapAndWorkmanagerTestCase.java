...
public class CustomBootstrapAndWorkmanagerTestCase
{
   ...
   /**
    * The Bootstrap context bean and friends
    *
   ...
   {
      return ResourceAdapterFactory.createTestDeployment(0, null, 0, "ConnectionFactory2", "TestAO2", "Second");
   }

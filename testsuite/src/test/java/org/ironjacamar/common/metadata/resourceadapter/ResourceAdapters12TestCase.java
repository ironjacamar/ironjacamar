...
/**
 * ResourceAdapters 1.2 tests
 * @author <a href="mailto:jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
public class ResourceAdapters12TestCase
{
   /**
    * Read
   ...
   public void testEqual() throws Exception
   {
      ...
      InputStream is1 = ResourceAdapters12TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/resourceadapter/dashra-1.2.xml");
      assertNotNull(is1);
      ...
      InputStream is2 = ResourceAdapters12TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/resourceadapter/dashra-1.2.xml");
      assertNotNull(is2);

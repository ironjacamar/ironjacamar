...
/**
 * IronJacamar 1.1 tests
 * @author <a href="mailto:jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
public class IronJacamar11TestCase
{
   /**
    * Read
   ...
   public void testEqual() throws Exception
   {
      ...
      InputStream is1 = IronJacamar11TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ironjacamar/ironjacamar-1.1.xml");
      assertNotNull(is1);
      ...
      InputStream is2 = IronJacamar11TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ironjacamar/ironjacamar-1.1.xml");
      assertNotNull(is2);

...
/**
 * DataSources 1.0 tests
 * @author <a href="mailto:jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
public class DataSources10TestCase
{
   /**
    * Read
   ...
   public void testRead() throws Exception
   {
      ...
      InputStream is = DataSources10TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ds/dashds-1.0.xml");
      assertNotNull(is);
   ...
   public void testEqual() throws Exception
   {
      ...
      InputStream is1 = DataSources10TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ds/dashds-1.0.xml");
      assertNotNull(is1);
      ...
      InputStream is2 = DataSources10TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ds/dashds-1.0.xml");
      assertNotNull(is2);

...
/**
 * DataSources 1.1 tests
 * @author <a href="mailto:jesper.pedersen@ironjacamar.org">Jesper Pedersen</a>
 */
public class DataSources11TestCase
{
   /**
    * Read
   ...
   public void testEqual() throws Exception
   {
      ...
      InputStream is1 = DataSources11TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ds/dashds-1.1.xml");
      assertNotNull(is1);
      ...
      InputStream is2 = DataSources11TestCase.class.getClassLoader().
         getResourceAsStream("../../resources/test/ds/dashds-1.1.xml");
      assertNotNull(is2);

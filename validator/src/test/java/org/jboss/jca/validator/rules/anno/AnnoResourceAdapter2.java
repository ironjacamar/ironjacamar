 ...
 */
@Connector()
public class AnnoResourceAdapter2 implements ResourceAdapter, java.io.Serializable
{
   ...
   public boolean equals(Object other)
   {
      ...
      if (other == this)
         return true;
      if (!(other instanceof AnnoResourceAdapter2))
         return false;
      boolean result = true;
      AnnoResourceAdapter2 obj = (AnnoResourceAdapter2)other;
      if (result)
      {
         if (first == null)

...
public class AnnoActivation1
{
   ...
   /** Activation spec */
   private AnnoActivationSpec1 spec;
    ...
    */
   public AnnoActivation1() throws ResourceException
   {
      this(null, null, null);
   }
    ...
    * @exception ResourceException Thrown if an error occurs
    */
   public AnnoActivation1(AnnoResourceAdapter ra, 
      MessageEndpointFactory endpointFactory,
      AnnoActivationSpec1 spec) throws ResourceException
    ...
    */
   public AnnoActivationSpec1 getActivationSpec()
   {
      return spec;
   }

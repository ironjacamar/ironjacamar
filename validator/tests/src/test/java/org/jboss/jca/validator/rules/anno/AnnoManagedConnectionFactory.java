...
@ConnectionDefinition(
   connectionFactory = AnnoConnectionFactory.class, 
   connectionFactoryImpl = AnnoConnectionFactoryImpl.class, 
   connection = AnnoConnection.class, 
   connectionImpl = AnnoConnectionImpl.class),
   @ConnectionDefinition(
           connectionFactory = AnnoConnectionFactory1.class, 
           connectionFactoryImpl = AnnoConnectionFactoryImpl1.class, 
           connection = AnnoConnection1.class, 
           connectionImpl = AnnoConnectionImpl1.class) })
public class AnnoManagedConnectionFactory implements ManagedConnectionFactory, ResourceAdapterAssociation
{
   ...
   /** The logger */
   private static Logger log = Logger.getLogger("AnnoManagedConnectionFactory");
   ...
   /** first */
   @ConfigProperty(defaultValue = "4", description =  {"1st", "first" }, 
    ...
    */
   @ConfigProperty(defaultValue = "0", description =  {"2nd", "second" }, 
